...
const HttpServer = function (conf, oconsole) {
	this._conf = conf;
...
HttpServer.prototype._startWatchingReqPool = function () {
...
HttpServer.prototype._defineRouting = function () {
	// CORS headers
...
HttpServer.prototype._assignReqId = function () {
	return (++this._req_id);
};

HttpServer.prototype.respond = function (http_code, data) {
	if (!('reqId' in data)) {
		return;
	}
...
HttpServer.prototype.wsSend = function (o) {
