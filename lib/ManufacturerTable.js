...
const ManufacturerTable = function () {
	this._manus = {};
};
...
* init()
* ---------------------------------------------------------------- */
ManufacturerTable.prototype.init = function () {
	// JSON を読み込む
...
* ---------------------------------------------------------------- */
ManufacturerTable.prototype.get = function (code) {
...
*   ]
* ---------------------------------------------------------------- */
ManufacturerTable.prototype.getList = function () {
	let list = [];
